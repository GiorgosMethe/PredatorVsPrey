...
public class PolicyEvaluation {
	...
	public static void main(String[] args) {
		...
		PolicyEvaluationImpl(new Coordinate(5, 5), 0.7);
		PolicyEvaluationImplSw(new Coordinate(5,5),0.7);
	...
	public static void PolicyEvaluationImplSw(Coordinate PreyPosition, double discountFactor) {
				...
				for (int j = 0; j < State.length; j++) {
					...
					if (rewardFunction(P.position, p.position) > 0) {
						...
						for (int ii = 0; ii < PredatorActions.size(); ii++) {
							...
							totalValue += PredatorActions.get(ii).prob*ValueCurrent;


						}

						State[i][j] = totalValue;
						delta = Math.max(delta, Math.abs(totalValue-preValue));					
	...
	public static void PolicyEvaluationImpl(Coordinate PreyPosition, double discountFactor) {
