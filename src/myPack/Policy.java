...
public abstract class Policy {
	...
	public abstract Vector<SimpleEntry<Action, Double>> getActions(Vector<Agent> worldState, Vector<Action> possibleActions);
	
	public Action getOptimalAction(Vector<Agent> worldState, Vector<Action> possibleActions) {
		Vector<SimpleEntry<Action, Double>> functionQ = getActions(worldState, possibleActions);
