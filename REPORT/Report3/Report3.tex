...
In this phase, we are going to illustrate through the following figures the performance that independent learning had in this multi-agent system. Figure~\ref{q2}, illustrates our results in independent \textit{Q-Learning}. Figure~\ref{q21}
Figure~\ref{q22}
Figure~\ref{q23}
Figure~\ref{qtest}
\begin{figure}[h!]
