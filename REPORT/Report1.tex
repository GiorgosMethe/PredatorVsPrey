...
\end{align*}
\Autoref{viat} presents the value table that was computed with the value iteration algorithm for a discount factor $\gamma = 0.7$ and $\theta = 0$.  The policy always taking the action with the highest expected value is depicted in \autoref{policy}.
\begin{figure}[h!]
\caption{The value function $V^\ast$ generated by Value Iteration, with the predator fixed at $\langle 5,5 \rangle$, discount factor $\gamma = 0.7$, and maximum error boundary $\theta = 0$.  The terminal state is represented by the symbol $\infty$.}
\label{viat}
\begin{center}
  \begin{tikzpicture}
    \node [biggrid] (A) at (0, 0) {}; 
\node at (A.center 1 11) {0.44}; \node at (A.center 2 11) {0.61}; \node at (A.center 3 11) {0.85}; \node at (A.center 4 11) {1.18}; \node at (A.center 5 11) {1.65}; \node at (A.center 6 11) {2.13}; \node at (A.center 7 11) {1.65}; \node at (A.center 8 11) {1.18}; \node at (A.center 9 11) {0.85}; \node at (A.center 10 11) {0.61}; \node at (A.center 11 11) {0.44};
\node at (A.center 1 10) {0.61}; \node at (A.center 2 10) {0.84}; \node at (A.center 3 10) {1.18}; \node at (A.center 4 10) {1.67}; \node at (A.center 5 10) {2.35}; \node at (A.center 6 10) {3.09}; \node at (A.center 7 10) {2.35}; \node at (A.center 8 10) {1.67}; \node at (A.center 9 10) {1.18}; \node at (A.center 10 10) {0.84};
\node at (A.center 11 10) {0.61}; 
\node at (A.center 1 9) {0.85}; \node at (A.center 2 9) {1.18}; \node at (A.center 3 9) {1.67}; \node at (A.center 4 9) {2.35}; \node at (A.center 5 9) {3.32}; \node at (A.center 6 9) {4.50}; \node at (A.center 7 9) {3.32}; \node at (A.center 8 9) {2.35}; \node at (A.center 9 9) {1.67}; \node at (A.center 10 9) {1.18}; \node at (A.center 11 9) {0.85};
\node at (A.center 1 8) {1.18}; \node at (A.center 2 8) {1.67}; \node at (A.center 3 8) {2.35}; \node at (A.center 4 8) {3.32}; \node at (A.center 5 8) {4.69}; \node at (A.center 6 8) {6.55}; \node at (A.center 7 8) {4.69}; \node at (A.center 8 8) {3.32}; \node at (A.center 9 8) {2.35}; \node at (A.center 10 8) {1.67}; \node at (A.center 11 8) {1.18};
\node at (A.center 1 7) {1.65}; \node at (A.center 2 7) {2.35}; \node at (A.center 3 7) {3.32}; \node at (A.center 4 7) {4.69}; \node at (A.center 5 7) {6.55}; \node at (A.center 6 7) {10.00}; \node at (A.center 7 7) {6.55}; \node at (A.center 8 7) {4.69}; \node at (A.center 9 7) {3.32}; \node at (A.center 10 7) {2.35}; \node at (A.center 11 7) {1.65};
\node at (A.center 1 6) {2.13}; \node at (A.center 2 6) {3.09}; \node at (A.center 3 6) {4.50}; \node at (A.center 4 6) {6.55}; \node at (A.center 5 6) {10.00}; \node at (A.center 6 6) {$\infty$}; \node at (A.center 7 6) {10.00}; \node at (A.center 8 6) {6.55}; \node at (A.center 9 6) {4.50}; \node at (A.center 10 6) {3.09}; \node at (A.center 11 6) {2.13};
\node at (A.center 1 5) {1.65}; \node at (A.center 2 5) {2.35}; \node at (A.center 3 5) {3.32}; \node at (A.center 4 5) {4.69}; \node at (A.center 5 5) {6.55}; \node at (A.center 6 5) {10.00}; \node at (A.center 7 5) {6.55}; \node at (A.center 8 5) {4.69}; \node at (A.center 9 5) {3.32}; \node at (A.center 10 5) {2.35}; \node at (A.center 11 5) {1.65};
\node at (A.center 1 4) {1.18}; \node at (A.center 2 4) {1.67}; \node at (A.center 3 4) {2.35}; \node at (A.center 4 4) {3.32}; \node at (A.center 5 4) {4.69}; \node at (A.center 6 4) {6.55}; \node at (A.center 7 4) {4.69}; \node at (A.center 8 4) {3.32}; \node at (A.center 9 4) {2.35}; \node at (A.center 10 4) {1.67}; \node at (A.center 11 4) {1.18};
\node at (A.center 1 3) {0.85}; \node at (A.center 2 3) {1.18}; \node at (A.center 3 3) {1.67}; \node at (A.center 4 3) {2.35}; \node at (A.center 5 3) {3.32}; \node at (A.center 6 3) {4.50}; \node at (A.center 7 3) {3.32}; \node at (A.center 8 3) {2.35}; \node at (A.center 9 3) {1.67}; \node at (A.center 10 3) {1.18}; \node at (A.center 11 3) {0.85};
\node at (A.center 1 2) {0.61}; \node at (A.center 2 2) {0.84}; \node at (A.center 3 2) {1.18}; \node at (A.center 4 2) {1.67}; \node at (A.center 5 2) {2.35}; \node at (A.center 6 2) {3.09}; \node at (A.center 7 2) {2.35}; \node at (A.center 8 2) {1.67}; \node at (A.center 9 2) {1.18}; \node at (A.center 10 2) {0.84}; \node at (A.center 11 2) {0.61};
\node at (A.center 1 1) {0.44}; \node at (A.center 2 1) {0.61}; \node at (A.center 3 1) {0.85}; \node at (A.center 4 1) {1.18}; \node at (A.center 5 1) {1.65}; \node at (A.center 6 1) {2.13}; \node at (A.center 7 1) {1.65}; \node at (A.center 8 1) {1.18}; \node at (A.center 9 1) {0.85}; \node at (A.center 10 1) {0.61}; \node at (A.center 11 1) {0.44};
\end{tikzpicture}
\end{center}
\end{figure}

\begin{figure}
  \caption{The policy based on the state-value function.  For every state, the policy choses either the action leading to the absorbing/terminal state (which has a transition probability of 1), or the action with the highest expected value.  The highest expected value is computed by $\max_a  \sum_{s'} \mathcal{P}_{s s'}^{a} \left[\mathcal{R}_{s s'}^{a} + \gamma V(s')\right]$.}
  \label{policy}
  \begin{center}
    \begin{tikzpicture}
      \node[biggrid] (A) at (0, 0) {};
      \node at (A.center 1 11) {$\rightdownarrow$}; \node at (A.center 2 11) {$\rightarrow$}; \node at (A.center 3 11) {$\rightdownarrow$}; \node at (A.center 4 11) {$\downarrow$}; \node at (A.center 5 11) {$\downarrow$}; \node at (A.center 6 11) {$\downarrow$}; \node at (A.center 7 11) {$\downarrow$}; \node at (A.center 8 11) {$\downarrow$}; \node at (A.center 9 11) {$\leftdownarrow$}; \node at (A.center 10 11) {$\leftarrow$}; \node at (A.center 11 11) {$\leftdownarrow$};
      \node at (A.center 1 10) {$\downarrow$}; \node at (A.center 2 10) {$\rightdownarrow$}; \node at (A.center 3 10) {$\rightdownarrow$}; \node at (A.center 4 10) {$\rightdownarrow$}; \node at (A.center 5 10) {$\downarrow$}; \node at (A.center 6 10) {$\downarrow$}; \node at (A.center 7 10) {$\downarrow$}; \node at (A.center 8 10) {$\leftdownarrow$}; \node at (A.center 9 10) {$\leftdownarrow$}; \node at (A.center 10 10) {$\leftdownarrow$}; \node at (A.center 11 10) {$\downarrow$};
      \node at (A.center 1 9) {$\rightdownarrow$}; \node at (A.center 2 9) {$\rightdownarrow$}; \node at (A.center 3 9) {$\rightdownarrow$}; \node at (A.center 4 9) {$\rightdownarrow$}; \node at (A.center 5 9) {$\downarrow$}; \node at (A.center 6 9) {$\downarrow$}; \node at (A.center 7 9) {$\downarrow$}; \node at (A.center 8 9) {$\leftdownarrow$}; \node at (A.center 9 9) {$\leftdownarrow$}; \node at (A.center 10 9) {$\leftdownarrow$}; \node at (A.center 11 9) {$\leftdownarrow$};
      \node at (A.center 1 8) {$\rightarrow$}; \node at (A.center 2 8) {$\rightdownarrow$}; \node at (A.center 3 8) {$\rightdownarrow$}; \node at (A.center 4 8) {$\rightdownarrow$}; \node at (A.center 5 8) {$\rightdownarrow$}; \node at (A.center 6 8) {$\downarrow$}; \node at (A.center 7 8) {$\leftdownarrow$}; \node at (A.center 8 8) {$\leftdownarrow$}; \node at (A.center 9 8) {$\leftdownarrow$}; \node at (A.center 10 8) {$\leftdownarrow$}; \node at (A.center 11 8) {$\leftarrow$};
      \node at (A.center 1 7) {$\rightarrow$}; \node at (A.center 2 7) {$\rightarrow$}; \node at (A.center 3 7) {$\rightarrow$}; \node at (A.center 4 7) {$\rightdownarrow$}; \node at (A.center 5 7) {$\rightdownarrow$}; \node at (A.center 6 7) {$\downarrow$}; \node at (A.center 7 7) {$\leftdownarrow$}; \node at (A.center 8 7) {$\leftdownarrow$}; \node at (A.center 9 7) {$\leftarrow$}; \node at (A.center 10 7) {$\leftarrow$}; \node at (A.center 11 7) {$\leftarrow$}; 
      \node at (A.center 1 6) {$\rightarrow$}; \node at (A.center 2 6) {$\rightarrow$}; \node at (A.center 3 6) {$\rightarrow$}; \node at (A.center 4 6) {$\rightarrow$}; \node at (A.center 5 6) {$\rightarrow$}; \node at (A.center 6 6) {$\circ$}; \node at (A.center 7 6) {$\leftarrow$}; \node at (A.center 8 6) {$\leftarrow$}; \node at (A.center 9 6) {$\leftarrow$}; \node at (A.center 10 6) {$\leftarrow$}; \node at (A.center 11 6) {$\leftarrow$};
      \node at (A.center 1 5) {$\rightarrow$}; \node at (A.center 2 5) {$\rightarrow$}; \node at (A.center 3 5) {$\rightarrow$}; \node at (A.center 4 5) {$\rightuparrow$}; \node at (A.center 5 5) {$\rightuparrow$}; \node at (A.center 6 5) {$\uparrow$}; \node at (A.center 7 5) {$\leftuparrow$}; \node at (A.center 8 5) {$\leftuparrow$}; \node at (A.center 9 5) {$\leftarrow$}; \node at (A.center 10 5) {$\leftarrow$}; \node at (A.center 11 5) {$\leftarrow$}; 
      \node at (A.center 1 4) {$\rightarrow$}; \node at (A.center 2 4) {$\rightuparrow$}; \node at (A.center 3 4) {$\rightuparrow$}; \node at (A.center 4 4) {$\rightuparrow$}; \node at (A.center 5 4) {$\rightuparrow$}; \node at (A.center 6 4) {$\uparrow$}; \node at (A.center 7 4) {$\leftuparrow$}; \node at (A.center 8 4) {$\leftuparrow$}; \node at (A.center 9 4) {$\leftuparrow$}; \node at (A.center 10 4) {$\leftuparrow$}; \node at (A.center 11 4) {$\leftarrow$};
      \node at (A.center 1 3) {$\rightuparrow$}; \node at (A.center 2 3) {$\rightuparrow$}; \node at (A.center 3 3) {$\rightuparrow$}; \node at (A.center 4 3) {$\rightuparrow$}; \node at (A.center 5 3) {$\uparrow$}; \node at (A.center 6 3) {$\uparrow$}; \node at (A.center 7 3) {$\uparrow$}; \node at (A.center 8 3) {$\leftuparrow$}; \node at (A.center 9 3) {$\leftuparrow$}; \node at (A.center 10 3) {$\leftuparrow$}; \node at (A.center 11 3) {$\leftuparrow$};
      \node at (A.center 1 2) {$\uparrow$}; \node at (A.center 2 2) {$\rightuparrow$}; \node at (A.center 3 2) {$\rightuparrow$}; \node at (A.center 4 2) {$\rightuparrow$}; \node at (A.center 5 2) {$\uparrow$}; \node at (A.center 6 2) {$\uparrow$}; \node at (A.center 7 2) {$\uparrow$}; \node at (A.center 8 2) {$\leftuparrow$}; \node at (A.center 9 2) {$\leftuparrow$}; \node at (A.center 10 2) {$\leftuparrow$}; \node at (A.center 11 2) {$\uparrow$};
      \node at (A.center 1 1) {$\rightuparrow$}; \node at (A.center 2 1) {$\rightarrow$}; \node at (A.center 3 1) {$\rightuparrow$}; \node at (A.center 4 1) {$\uparrow$}; \node at (A.center 5 1) {$\uparrow$}; \node at (A.center 6 1) {$\uparrow$}; \node at (A.center 7 1) {$\uparrow$}; \node at (A.center 8 1) {$\uparrow$}; \node at (A.center 9 1) {$\leftuparrow$}; \node at (A.center 10 1) {$\leftarrow$}; \node at (A.center 11 1) {$\leftuparrow$};
    \end{tikzpicture}
  \end{center}
\end{figure}
